...
<br><h1 class="f2">Delete Events</h1><br>
<form class="form-group" action= "DeleteEve" method= "post">
Event name: <input class="form-control" type= "text" name= "e_name" required><br>
<div class="f2">
<input class="btn btn-primary" type= "submit" value= "Delete event"><br></div>
</form>
