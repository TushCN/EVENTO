...
<br><h1 class="f2">Delete records</h1><br>
<form class="form-group" action= "DeleteRec" method= "post">
Enter username: <input class="form-control" type= "text" name= "u_name"><br>
<div class="f2">
<input class="btn btn-primary"  type= "submit" value= "Delete record">
</div>
</form>
