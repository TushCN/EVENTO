...
<br><h1 class="f2">Insert new event</h1><br>
<form class="form-group" action= "InsertEvent" method= "post" onsubmit= "return validaton()">
...
<div class="f2">
<input class="btn btn-primary" type= "submit" value= "Insert event">
</div>
</form>
<form action= "Logout" method= "post">
<div class="f2">
<input class="btn btn-primary f2" type= "submit" value= "Logout" style="margin-bottom: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/EventManagement/AdminOpt.jsp"><input class="btn btn-primary" type= "button" value= "Previous"></a>
</div>
</form>
</div>
</body>
